...
# Windows Keep-Open Reference

Status: IMPLEMENTED_AND_LOCAL_TESTED

The CMD launcher is now visible-by-default and persists console stdout/stderr before it exits.
Automated callers can set `QIKVRT_NO_PAUSE=1`.
