# QV2134Q Node Git Idempotent Tag Push Repair

# QIKVRT V2.13.4Q Node Git Idempotent Tag Push Repair
...
2.13.4Q removes local GitHub Release REST create/upload from the node deploy path.
