...
# Node Onboarding Testbed Reference Result

Reference status: NODE_ONBOARDING_TESTBED_REQUIRED.

The runtime selftest `--selftest-node-onboarding-testbed` verifies the generic QIKVRT node onboarding chain from the Ontology of Difference through constitutional gates, bootstrap, seed discovery, watchdog, live evidence and REST API contract boundaries.

Expected reference result:

```text
PASS QIKVRT node onboarding full testbed selftest v2.11.9
checks=25 failures=0 articles=0
```
