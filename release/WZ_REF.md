...
# Windows Zig Bootstrap Reference

Status: implemented in qv2116w.

Purpose: close `WINDOWS_LLVM_CLANG_PRESENT_BUT_NOT_LINKABLE` by adding Zig bootstrap and cross-platform C source compatibility for Windows sockets and filesystem calls.
