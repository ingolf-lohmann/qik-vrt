...
# Short Path Reference Result v2.11.1

- Archive: qv211.zip
- Archive basename length: 10
- Internal max path length: <= 80
- Root-flat content: required
- Windows external runner: requires owner TSV confirmation
- No final Windows extraction PASS without external report
