...
# Node Onboarding Reference Result

Status: REFERENCE_PASS

V2.11.8 replaces any person-bound default node with a generic QIKVRT Node Onboarding profile.

Checks:
- GENERIC_NODE_PROFILE = PASS
- NO_PERSON_BOUND_DEFAULT = PASS
- REPOSITORY_GUID_REQUIRED = PASS
- AUTHORIZED_SEED_GRAPH = PASS
- PRIVACY_PRESERVED_EVIDENCE = PASS
- WATCHDOG_READY = PASS
- SELFTEST_REQUESTABLE = PASS
- HANDOVER_READY = PASS
