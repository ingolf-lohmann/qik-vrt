...
# Unified Node Core Reference

Status: PASS_READY_FOR_TEST

This reference records the corrected architecture: all QIKVRT nodes use the same API and inner core. Runtime role configuration selects `normal` or `seed`; only role-specific assertions differ.
