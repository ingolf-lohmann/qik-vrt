...
# V2.11 Article Claim Matrix Reference Result

Status: `CLAIM_MATRIX_ENFORCED`.

The article's claims are no longer treated as uniform implementation claims.
Each claim must be classified as implemented, live-test-required, soak-test-required, externally-reproduced-required, future application, conceptual, or not claimed.
