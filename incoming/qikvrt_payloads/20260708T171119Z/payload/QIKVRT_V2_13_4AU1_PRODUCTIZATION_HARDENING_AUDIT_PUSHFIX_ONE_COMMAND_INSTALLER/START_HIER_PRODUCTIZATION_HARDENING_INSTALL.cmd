...
cd /d "%~dp0"
echo QIKVRT V2.13.4AU1 Productization Hardening Audit Pushfix Installer
echo =====================================================
...
echo.
if not exist "tools\qikvrt_4au_installer.js" (
  echo BLOCK missing tools\qikvrt_4au_installer.js
...
cscript.exe //Nologo //E:JScript "tools\qikvrt_4au_installer.js"
set ec=%ERRORLEVEL%
