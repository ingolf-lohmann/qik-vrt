...
cd /d "%~dp0"
echo QIKVRT V2.13.4AT Autonomous Seed/Node Mesh Maintenance Installer
echo ================================================================
...
echo.
if not exist "tools\qikvrt_4at_installer.js" (
  echo BLOCK missing tools\qikvrt_4at_installer.js
...
cscript.exe //Nologo //E:JScript "tools\qikvrt_4at_installer.js"
set ec=%ERRORLEVEL%
