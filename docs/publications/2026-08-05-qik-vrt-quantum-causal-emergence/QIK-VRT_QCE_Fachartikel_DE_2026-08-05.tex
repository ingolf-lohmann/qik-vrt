...
Der QCE-Quellkern wurde mit Lean 4.19.0 kernelgeprüft. Das Paket enthält
das exakt gebundene Receipt, den Axiom-Audit-Output, den
Verifikationsoutput und die Artefaktprovenienz aus dem erfolgreichen
GitHub-Actions-Lauf \texttt{31467654213}. Der Receipt bindet den
Verifikations-Carrier-Commit
\texttt{225675ae2145aec709103f843cd26fd6893b39ba} und dessen Tree
\texttt{94eafdc41f42c3c5107275212351c323653dcb35}; der Paketprüfer
bestätigt die Gleichheit der gebundenen Modell- und Axiom-Audit-Bytes
mit dem vorliegenden Paket.

Die physikalische Korrespondenz bleibt unabhängig davon offen.

\texttt{FORMAL\_SOURCE\ =\ EXECUTED\_BYTES\_BOUND}

\texttt{LEAN\_EXECUTION\ =\ EXECUTED\_RECEIPT\_PRESENT}
