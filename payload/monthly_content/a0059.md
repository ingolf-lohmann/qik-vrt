...
## V8 Full Acceptance Coverage

Status:

```text
FULL_ACCEPTANCE_COVERAGE_LAYER_MATERIALIZED
```
...
Lokaler Coverage-PASS bedeutet: Acceptance-Test-Abdeckung, Pflichtdateien, Marker, Manifest/SHA256, README-Kommandos, Secret-Scan und Nichtrekursion sind lokal geprüft. Externe GitHub-/Zenodo-DONE-Freigabe bleibt blockiert bis echte externe Evidenz vorhanden ist.
...
```text
MASTER_ACCEPTANCE_GATE_MATERIALIZED
```

Der Master-Gate prüft statisch und nicht-rekursiv. Er ersetzt nicht die externen GitHub-/Zenodo-Nachweise. Externes DONE bleibt blockiert bis reale externe Evidenz vorliegt.
