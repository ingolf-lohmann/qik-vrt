...
V45.12 repairs the V45.4 usability break where the real release wrapper immediately blocked unless the user manually set `QIKVRT_ENABLE_REAL_GITHUB_EFFECTS=YES`. The official wrapper now performs the correct sequence:
...
6. require `audit/github_remote_effect_evidence.v45.12.json` for final PASS.
